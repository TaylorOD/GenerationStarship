...
function timeCruncher(t) {
	...
	var sDisplay = s.toFixed(2) + (s <= 1.0 ? ' second' : ' seconds');
...
window.setInterval(function () {
	...
	if (endTimer6 == 300 && milestoneFlag == 15) {
		displayMessage('');
	}
	if (endTimer6 == 310 && milestoneFlag == 15) {
		displayMessage('');
	}
	if (endTimer6 == 320 && milestoneFlag == 15) {
		displayMessage('');
	}
	if (endTimer6 == 330 && milestoneFlag == 15) {
		displayMessage('');
	}
	if (endTimer6 == 340 && milestoneFlag == 15) {
		displayMessage('');
	}
	if (endTimer6 == 350 && milestoneFlag == 15) {
		displayMessage('');
	}
	if (endTimer6 == 360 && milestoneFlag == 15) {
		displayMessage('');
	}
	if (endTimer6 == 370 && milestoneFlag == 15) {
		displayMessage('');
	}
...
function resetButtonClock() {
	if (confirm('Reset current Universe?')) {
		reset();
	}
	...
	if (
		prestigeU > 0 ||
		prestigeS > 0 ||
		localStorage.getItem('savePrestige') != null
	) {
		if (confirm('Reset prestige?')) {
			resetPrestige();
		}
	}
}
